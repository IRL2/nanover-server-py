...
1. ** 2g5n_complex.openmm.zip ** : trypsin and indole-amidine, based on PDB file 2G5N. 
    An 800 kJ/mol/nm2 restraint was added to all backbone atoms of trypsin.
2.  ** hiv1_complex.openmm.zip ** : HIV-1 protease and amprenavir, based on PDB file 1HPV.
...
3.  ** 6hcx_complex.openmm.zip ** : neuraminidase and zanamivir, based on PDB file 6HCX.
    No restraint is applied to the complex.

All files have been converted from Narupa OpenMM XMLs (.xml) to NanoVer OpenMM bundles (.openmm.zip)