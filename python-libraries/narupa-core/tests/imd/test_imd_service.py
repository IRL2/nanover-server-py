...
def test_add_duplicate_interaction_id():
    service = ImdStateWrapper(StateDictionary())
    service.insert_interaction('interaction.test', ParticleInteraction())
    service.insert_interaction('interaction.test', ParticleInteraction())
...
def test_multiple_keys():
    service = ImdStateWrapper(StateDictionary())
    service.insert_interaction('interaction.test1', ParticleInteraction())
    service.insert_interaction('interaction.test2', ParticleInteraction())
