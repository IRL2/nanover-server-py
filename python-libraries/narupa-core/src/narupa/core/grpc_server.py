...
class GrpcServer:
    ...
    def add_service(self, service, add_service_method: Callable[[object, grpc.server], None]):
        """
        Add a gRPC service to this server.
        :param service: The gRPC service to add
        :param add_service_method: Method to add service to the server, this is generated by
        protoc.
        """

        add_service_method(service, self.server)
