...
def test_run_play(client_server, mock_callback):
    client, app_server = client_server
    app_server.server.register_command(PLAY_COMMAND_KEY, mock_callback)
    client.run_play()
...
def test_run_reset(client_server, mock_callback):
    client, app_server = client_server
    app_server.server.register_command(RESET_COMMAND_KEY, mock_callback)
    client.run_reset()
    mock_callback.assert_called_once()
...
def test_run_step(client_server, mock_callback):
    client, app_server = client_server
    app_server.server.register_command(STEP_COMMAND_KEY, mock_callback)
    client.run_step()
    mock_callback.assert_called_once()
...
def test_run_pause(client_server, mock_callback):
    client, app_server = client_server
    app_server.server.register_command(PAUSE_COMMAND_KEY, mock_callback)
    client.run_pause()
    mock_callback.assert_called_once()
...
def test_available_commands(client_server, mock_callback):
    client, app_server = client_server
    app_server.server.register_command(frame_str, mock_callback)
    app_server.server.register_command(imd_str, mock_callback)
    app_server.server.register_command(multiplayer_str, mock_callback)
