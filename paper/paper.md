...
![Attempt alt text \label{fig:nanover-systems-diagram}](./nanover-systems-diagram.png "Systems diagram of the NanoVer ecosystem for iMD (displayed within the grey box) that illustrates how NanoVer Server communicates data between the molecular simulation engine and connected clients, and between clients themselves. The orange boxes indicate the contents of the GitHub repositories for NanoVer Server ([nanover-server-py](https://github.com/IRL2/nanover-server-py)) and NanoVer iMD-VR ([nanover-imd-vr](https://github.com/IRL2/nanover-imd-vr)).\label{fig:nanover-systems-diagram}")
